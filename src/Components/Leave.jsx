...
const Leave = () => {
  ...
  <div>
    ...
    <i class='fas fa-arrow-right' style={{fontSize:50,marginLeft:750,color:'yellowgreen',marginTop:100}}></i>
    <Link to={`/micro/` + employee.id} className="btn btn-primary w-25 text-white" style={{borderRadius:100, marginLeft:800, backgroundColor:'#4CAF50',color:'white',marginTop:-80}}><b>For Logout Click here</b></Link>
   <br/><br/>
  
    <form className="row g-1 d-flex justify-content-center align-items-center mt-3"  onSubmit={handleSubmit} style={{width:500, marginLeft:300,backgroundColor:'yellowgreen',padding:15,borderRadius:30}}>
    <h1 className='text-black' >-:Employee Attendance:-</h1>
         <br/><br/>
          <div className="col-12" >
            ...
            <div className="col-12">
              <label for="status" className="form-label text-black"><b>Name:-</b>{employee.name}<br/>
                <input type='checkbox' value={employee.name} onChange={(e) => setAttendance({...attendance, emp_name: e.target.value})}/><b>is your Current address</b>
              </label>
            </div>
