    ...
    <div className='dts'>
      <div className='px-5 mt-3 apj' style={{ marginTop: 40, height: 750 }}>
        <div className='d-flex justify-content-around mt-3'>
          ...
          <div className='px-3 pt-2 pb-3 border shadow-sm w-25 text-white jbb' style={{ height: 110, backgroundColor: 'purple', borderRadius: 20, marginTop: 100 }}>
            <div className='text-center pb-1'>
              <h4>Leave</h4>
            </div>
            <hr/>
        ...
        <div className='jbb' style={{ marginTop: -63, marginBottom: 6, marginLeft: 370 }}>
        ...
        <div className='jbb' style={{ marginTop: -66, marginBottom: 6, marginLeft: 690 }}>
