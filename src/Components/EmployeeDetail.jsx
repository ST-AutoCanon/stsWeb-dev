  ...
  return (
   <div className='container-fluid detailpage'>
    <div className='row flex-nowrap' >
        ...
        <div className='col p-0 m-0 page'>
    ...
    <div className='mt-3'>
            ...
            <table className='table'  style={{marginTop:70}}>
              <div className='page'></div>
                <thead >
                    <tr>
                        <th  style={{backgroundColor: 'skyblue'}} >Name</th>
                        <th  style={{backgroundColor: 'orange'}}>Email</th>
                        <th  style={{backgroundColor: 'blueviolet'}}>Salary</th>
                        <th style={{backgroundColor: 'pink'}}>Address</th> 
                        <th  style={{backgroundColor: ' green'}}>Aadhar_number</th>  
                        <th  style={{backgroundColor: 'orange'}}>Pan_number</th>
                    </tr>
                </thead>
                <tbody>
                        <tr>   
                            <td  style={{backgroundColor: 'skyblue'}}>{employee.name}</td>
                            <td style={{backgroundColor: 'orange'}}>{employee.email}</td>
                            <td  style={{backgroundColor: 'blueviolet'}}>{employee.salary}</td>
                            <td  style={{backgroundColor: 'pink'}}>{employee.address}</td>
                            <td  style={{backgroundColor: ' green'}} >{employee.aadhar_number}</td>
                            <td  style={{backgroundColor: 'orange'}}>{employee.pan_number}</td>
                        </tr>
                </tbody>
            </table>
        </div>
